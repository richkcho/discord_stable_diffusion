...
class DiscordStableDiffusionGenerationCommands(commands.Cog):
    ...
    def handle_typing(self, channel: Union[discord.abc.GuildChannel, discord.PartialMessageable, discord.Thread]):
    ...
    async def process_request(self, ctx: discord.ApplicationContext, prompt: str, negative_prompt: str, **values: dict):
        ...
        self.handle_typing(ctx.channel)
    ...
    async def generate(self, ctx: discord.ApplicationContext,
        ...
        await self.process_request(ctx, prompt, negative_prompt, **values)
